...
<body>
    ...
    <div class="screen">
        <div class="mid">
            <div class="div-start"><button class="start" type="button" id="startBtn" onclick="quizStart()">Quiz Başlat</button></div>
            <div id="demo"></div>
        </div>
    </div>
            ...
            if(count+1 < 10) {
                ...
                if(correct < 5) {
                    _('demo').innerHTML = `
                        <div class="frame">
                            <div class="rest-div"><div onclick="reloadPage()" class="rest"><i class="fas fa-sync-alt"></i></div></div>
                            <div class="fail">Başarısız<span>10 sorudan `+correct+` soru doğru</span></div>
                        </div>
                    `;
                    ...
                    _('demo').innerHTML = `
                        <div class="frame">
                            <div class="rest-div"><div onclick="reloadPage()" class="rest"><i class="fas fa-sync-alt"></i></div></div>
                            <div class="medium">Başarılı<span>10 sorudan `+correct+` soru doğru</span></div>
                        </div>
                    `;
                } else if(correct == 10) {
                    _('demo').innerHTML = `
                        <div class="frame">
                            <div class="rest-div"><div onclick="reloadPage()" class="rest"><i class="fas fa-sync-alt"></i></div></div>
                            <div class="success">Tam Puan Tebrikler<span>10 sorudan `+correct+` soru doğru</span></div>
                        </div>
                    `;
                }
                $('.screen').after(`

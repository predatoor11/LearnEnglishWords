...
<body>
    ...
    <div class="screen">
        <div class="mid">
            <div class="div-start"><button class="start" type="button" id="startBtn" onclick="quizStart()">Tüm Kelimeler Testini Başlat</button></div>
            <div id="demo"></div>
            <!-- <div class="frame">
                <div class="rest-div"><div onclick="reloadPage()" class="rest"><i class="fas fa-sync-alt"></i></div></div>
                <div class="success">Success<span>5 Soru Doğru</span></div>
                <div class="question">
                    Soru Soru Soru Soru Soru Soru Soru Soru Soru Soru?
                </div>
                <div class="choices">
                    <div class="choice"><input type="radio" name="choice" id="choice" value="A">&nbsp;<label for="choice">TEST</label></div>
                    <div class="choice"><input type="radio" name="choice" id="choice2" value="A">&nbsp;<label for="choice2">TEST</label></div>
                </div>
                <div class="answer">
                    <button type="button">Cevapla</button>
                </div>
